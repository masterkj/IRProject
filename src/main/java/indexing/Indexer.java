...
public class Indexer {
     Map<String, HashMap<String, Integer>> wordFrequency = new HashMap<>();
     Map<String, HashMap<String, Double>> tf = new HashMap<>();
     Map<String, Double> idf = new HashMap<>();
     Map<String, HashMap<String, Double>> index = new HashMap<>();
